...
<head>
    ...
    <title>{{ $title ?? 'icomesh' }}</title>
    <meta name="description" content="international conferencce on medical science and health (icomesh)">
    <meta name="keywords" content="icomesh, unila">

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="article">
    <meta property="og:url" content="{{ URL::current() }}">
    <meta property="og:title" content="{{ $title ?? 'icomesh' }}">
    <meta property="og:description" content="{{ $title ?? 'international conferencce on medical science and health (icomesh)' }}">
    ...
    <meta property="twitter:description" content="{{ $title ?? 'international conferencce on medical science and health (icomesh)' }}">
