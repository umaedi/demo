...
<div class="container p-2 flex h-screen overflow-hidden">
  ...
  <div class="right-content w-full md:w-1/2 overflow-scroll py-10 px-4 md:p-10 flex flex-col gap-5">
      ...
      <div class="input-area flex flex-col gap-10">
          <!-- Input -->
          ...
          <div class="wrapper flex flex-col gap-2">
              ...
              <div class="form-control w-full">
                  ...
                  <input type="email" placeholder="Example: wahyuaji@gmail.com"
                      class="input input-bordered input-accent w-full text-sm" name="email" />
              </div>
              <!-- Password -->
              <div class="form-control w-full">
                  <label class="label">
                  ...
                  <input type="password" placeholder="****************"
                      class="input input-bordered input-accent w-full text-sm" name="password"/>
                  <label class="label">
                      <a onclick="forgot_password.showModal()"
                          class="cursor-pointer label-text text-xs text-primary">Forgot Password?</a>
                  </label>
              </div>
          </div>
      ...
      <div class="wrapper w-fit">
          <a href="./../../index.html" class="text-mydark hover:text-primary text-sm flex gap-1 items-center">
...
<dialog id="forgot_password" class="modal modal-bottom sm:modal-middle">
  <form method="dialog" class="modal-box text-mydark">
      <h3 class="text-mydark font-bold text-2xl md:text-3xl">Forgot Password</h3>
      <p class="py-4 text-sm">Please give us your registered email & we'll send you a link to reset your password
      </p>
      ...
      <div class="modal-action">
          ...
          <button class="btn text-xs w-full rounded-xl">CANCEL</button>
      </div>
  </form>
</dialog>
@endsection